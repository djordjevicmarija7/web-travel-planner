...
namespace TravelService.Services
{
    public class DestinationService : IDestinationService
    {
        ...
        public async Task<DestinationDto> CreateAsync(int tripId, CreateDestinationDto dto, int userId, bool isAdmin = false)
        {
            var trip = await _context.Trips
                .FirstOrDefaultAsync(t => t.Id == tripId && (t.UserId == userId || isAdmin));
        ...
        public async Task<bool> DeleteAsync(int id, int tripId, int userId, bool isAdmin = false)
        {
            bool tripExists = await _context.Trips.AnyAsync(t => t.Id == tripId && (t.UserId == userId || isAdmin));
        ...
        public async Task<List<DestinationDto>> GetAllByTripAsync(int tripId, int userId, bool isAdmin = false)
        {
            bool tripExists = await _context.Trips
                .AnyAsync(t => t.Id == tripId && (t.UserId == userId || isAdmin));
            if (!tripExists)
            {
        ...
        public async Task<DestinationDto?> GetByIdAsync(int id, int tripId, int userId, bool isAdmin = false)
        {
            bool tripExists = await _context.Trips
               .AnyAsync(t => t.Id == tripId && (t.UserId == userId || isAdmin));
            if (!tripExists)
        ...
        public async Task<DestinationDto?> UpdateAsync(int id, int tripId, UpdateDestinationDto dto, int userId, bool isAdmin = false)
        {
            var trip = await _context.Trips
                .FirstOrDefaultAsync(t => t.Id == tripId && (t.UserId == userId || isAdmin));
